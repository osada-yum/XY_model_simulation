program mpi_xy2d_periodic_correlation_dual_lattice_simulation
  use, intrinsic :: iso_fortran_env
  use mpi
  use gf2xe
  use msmt19937
  use xy2d_periodic_correlation_dual_lattice_m
...
end program mpi_xy2d_periodic_correlation_dual_lattice_simulation
