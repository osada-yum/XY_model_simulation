module xy2d_periodic_correlation_simple_m
  ...
  integer(int64), parameter, public :: nx = 1000, ny = nx, nall = nx * ny
...
program xy2d_periodic_wolff_equilibrium_simulation
  ...
  implicit none
  integer(int32), parameter :: mcs_discard = 100000_int32, mcs_sample = 10000_int32
  ...
  real(real64), parameter :: temperatures(*) = &
       ...
       & 1.0d0, 1.1d0, 1.5d0, 2.0d0, 2.5d0, 3.0d0]
